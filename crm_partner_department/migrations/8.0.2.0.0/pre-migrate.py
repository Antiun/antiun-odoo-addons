...
OLD_MODULE = "crm_partner_department"
NEW_MODULE = "partner_contact_department"
...
def migrate(cr, version):
    ...
    secure_migration(
        cr,
        model_rename("crm.department",
                     "res.partner.department",
                     MAGIC_COLUMNS + ["name", "parent_id", "parent_left",
                                      "parent_right"]),
        model_remove("crm.department"),
        model_rename("res.partner", "res.partner"),
        column_rename("res.partner", "department", "department_id"),
    )
